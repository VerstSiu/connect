...
open class ConnectManagerTestQuarter: ConnectManagerTestTriple() {
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> NtcSuccess       -> Disconnect    -> NtcSuccess, NtcError, Disconnect, RtConnect, RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECT_COMPLETE    DISCONNECTING    DISCONNECTING
  // SUCCESS        :                         TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  @Test fun testQuarterConnectNtcSuccessDisconnectRfConnectFF() = testQuarterConnectNtcSuccessDisconnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNtcSuccessDisconnectRfConnectFT() = testQuarterConnectNtcSuccessDisconnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNtcSuccessDisconnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectNtcSuccessDisconnect(manager)
  ...
  protected fun testQuarterConnectNtcSuccessDisconnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectNtcSuccessDisconnect(manager)
  ...
  // PAUSED         :                                             TRUE             TRUE
  //
  //                  Create -> Connect    -> NtcSuccess       -> PsConnect     -> RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECT_COMPLETE    DISCONNECTING    DISCONNECTING
  // SUCCESS        :                         TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                             TRUE             TRUE
  ...
  @Test fun testQuarterConnectNtcSuccessPsConnectRfConnectFF() = testQuarterConnectNtcSuccessPsConnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNtcSuccessPsConnectRfConnectFT() = testQuarterConnectNtcSuccessPsConnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNtcSuccessPsConnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectNtcSuccessPsConnect(manager)
  ...
  protected fun testQuarterConnectNtcSuccessPsConnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectNtcSuccessPsConnect(manager)
  ...
  // Test Cases:
  //                  Create -> Connect    -> NtcSuccess       -> RfConnectFT   -> Connect, NtcSuccess, NtcError, RtConnect, RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECT_COMPLETE    DISCONNECTING    DISCONNECTING
  // SUCCESS        :                         TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                             TRUE             TRUE
  ...
  @Test fun testQuarterConnectNtcSuccessRfConnectFTRfConnectFF() = testQuarterConnectNtcSuccessRfConnectFTRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNtcSuccessRfConnectFTRfConnectFT() = testQuarterConnectNtcSuccessRfConnectFTRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNtcSuccessRfConnectFTRfConnectFF(manager: ConnectManager) {
    testTripleConnectNtcSuccessRfConnectFT(manager)
  ...
  protected fun testQuarterConnectNtcSuccessRfConnectFTRfConnectFT(manager: ConnectManager) {
    testTripleConnectNtcSuccessRfConnectFT(manager)
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> NtcError(*,0)    -> Disconnect          -> NtcSuccess, NtcError, Disconnect, NtdSuccess, NtdError, NtsClosed, NteClosed, RtConnect, RsConnect, RfConnectFF, RfConnectFT
  ...
  @Test fun testQuarterConnectNtcErrorDisconnectRfConnectFF() = testQuarterConnectNtcErrorDisconnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNtcErrorDisconnectRfConnectFT() = testQuarterConnectNtcErrorDisconnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNtcErrorDisconnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectNtcErrorDisconnect(manager)
  ...
  protected fun testQuarterConnectNtcErrorDisconnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectNtcErrorDisconnect(manager)
  ...
  // PAUSED         :                                             TRUE
  //
  //                  Create -> Connect    -> NtcError(*,0)    -> PsConnect           -> RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECT_COMPLETE    DISCONNECT_COMPLETE    CONNECTING
  // SUCCESS        :                         FALSE               TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  @Test fun testQuarterConnectNtcErrorPsConnectRfConnectFF() = testQuarterConnectNtcErrorPsConnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNtcErrorPsConnectRfConnectFT() = testQuarterConnectNtcErrorPsConnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNtcErrorPsConnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectNtcErrorPsConnect(manager)
  ...
  protected fun testQuarterConnectNtcErrorPsConnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectNtcErrorPsConnect(manager)
  ...
  // Test Cases:
  //                  Create -> Connect    -> NtcError(true,1) -> RtConnect        -> Connect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    RETRY_CONNECTING    RETRY_CONNECTING    CONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :                         0                   0
  // WAIT_CONNECT   :
  // WAIT_DISCONNECT:
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> NtcError(true,-1) -> RtConnect       -> NtcError(false,-1), NtsClosed(false,-1), NteClosed(false,-1)
  // STATE          : null      CONNECTING    RETRY_CONNECTING    RETRY_CONNECTING    RETRY_CONNECT_COMPLETE
  // SUCCESS        :                                                                 FALSE
  // RETRY_COUNT    :                         0                   0
  // WAIT_CONNECT   :
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> NtcError(true,2) -> RtConnect        -> NtcError(false,2), NtsClosed(false,2), NteClosed(false,2)
  // STATE          : null      CONNECTING    RETRY_CONNECTING    RETRY_CONNECTING    RETRY_CONNECT_COMPLETE
  // SUCCESS        :                                                                 FALSE
  // RETRY_COUNT    :                         0                   0
  // WAIT_CONNECT   :
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> NtcError(true,1) -> RtConnect        -> NtdSuccess, NtdError, RtConnect, RsConnect
  // STATE          : null      CONNECTING    RETRY_CONNECTING    RETRY_CONNECTING    RETRY_CONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :                         0                   0                   0
  // WAIT_CONNECT   :
  ...
  @Test fun testQuarterConnectNtcErrorRetryRtConnectRfConnectFF() = testQuarterConnectNtcErrorRetryRtConnectRfConnectFF(createManagerPair())
  @Test fun testQuarterConnectNtcErrorRetryRtConnectRfConnectFT() = testQuarterConnectNtcErrorRetryRtConnectRfConnectFT(createManagerPair())
  ...
  protected fun testQuarterConnectNtcErrorRetryRtConnectNtcSuccess(pair: Pair<ConnectManager, MockHandler>) {
    val manager = pair.first
    testTripleConnectNtcErrorRetryRtConnect(pair)
  ...
  protected fun testQuarterConnectNtcErrorRetryRtConnectRfConnectFF(pair: Pair<ConnectManager, MockHandler>) {
    val manager = pair.first
    testTripleConnectNtcErrorRetryRtConnect(pair)
  ...
  protected fun testQuarterConnectNtcErrorRetryRtConnectRfConnectFT(pair: Pair<ConnectManager, MockHandler>) {
    val manager = pair.first
    testTripleConnectNtcErrorRetryRtConnect(pair)
  ...
  // Test Cases:
  //                  Create -> Connect    -> NtcError(true,1) -> PsConnect           -> Connect, RfConnectFF, RfConnectFT
  ...
  @Test fun testQuarterConnectNtcErrorRetryPsConnectRfConnectFF() = testQuarterConnectNtcErrorRetryPsConnectRfConnectFF(createManagerPair())
  @Test fun testQuarterConnectNtcErrorRetryPsConnectRfConnectFT() = testQuarterConnectNtcErrorRetryPsConnectRfConnectFT(createManagerPair())
  ...
  protected fun testQuarterConnectNtcErrorRetryPsConnectRfConnectFF(pair: Pair<ConnectManager, MockHandler>) {
    val manager = pair.first
    testTripleConnectNtcErrorRetryPsConnect(pair)
  ...
  protected fun testQuarterConnectNtcErrorRetryPsConnectRfConnectFT(pair: Pair<ConnectManager, MockHandler>) {
    val manager = pair.first
    testTripleConnectNtcErrorRetryPsConnect(pair)
  ...
  // Test Cases:
  //                  Create -> Connect    -> Disconnect    -> NtcSuccess    -> Connect
  // STATE          : null      CONNECTING    CONNECTING       DISCONNECTING    DISCONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                                           TRUE
  // WAIT_DISCONNECT:                         TRUE
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> Disconnect    -> NtcSuccess    -> NtcSuccess, NtcError, Disconnect, RtConnect, RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECTING       DISCONNECTING    DISCONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> Disconnect    -> NtcSuccess    -> NtdSuccess, NtsClosed
  // STATE          : null      CONNECTING    CONNECTING       DISCONNECTING    DISCONNECT_COMPLETE
  // SUCCESS        :                                                           TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  // WAIT_DISCONNECT:                         TRUE
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> Disconnect    -> NtcSuccess    -> NtdError, NteClosed
  // STATE          : null      CONNECTING    CONNECTING       DISCONNECTING    DISCONNECT_COMPLETE
  // SUCCESS        :                                                           FALSE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> Disconnect    -> NtcSuccess    -> PsConnect
  // STATE          : null      CONNECTING    CONNECTING       DISCONNECTING    DISCONNECT_COMPLETE
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  @Test fun testQuarterConnectDisconnectNtcSuccessConnect() = testQuarterConnectDisconnectNtcSuccessConnect(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNtcSuccess() = testQuarterConnectDisconnectNtcSuccessNtcSuccess(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNtcError() = testQuarterConnectDisconnectNtcSuccessNtcError(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessDisconnect() = testQuarterConnectDisconnectNtcSuccessDisconnect(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNtdSuccess() = testQuarterConnectDisconnectNtcSuccessNtdSuccess(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNtdError() = testQuarterConnectDisconnectNtcSuccessNtdError(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNtsClosed() = testQuarterConnectDisconnectNtcSuccessNtsClosed(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessNteClosed() = testQuarterConnectDisconnectNtcSuccessNteClosed(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessRtConnect() = testQuarterConnectDisconnectNtcSuccessRtConnect(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessPsConnect() = testQuarterConnectDisconnectNtcSuccessPsConnect(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessRsConnect() = testQuarterConnectDisconnectNtcSuccessRsConnect(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessRfConnectFF() = testQuarterConnectDisconnectNtcSuccessRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectDisconnectNtcSuccessRfConnectFT() = testQuarterConnectDisconnectNtcSuccessRfConnectFT(ConnectManager())

  protected fun testQuarterConnectDisconnectNtcSuccessConnect(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNtcSuccess(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNtcError(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessDisconnect(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNtdSuccess(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNtdError(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNtsClosed(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessNteClosed(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessRtConnect(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessPsConnect(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessRsConnect(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessRfConnectFF(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectDisconnectNtcSuccessRfConnectFT(manager: ConnectManager) {
    testTripleConnectDisconnectNtcSuccess(manager)
  ...
  // PAUSED         :
  //
  //                  Create -> Connect    -> Disconnect    -> NteClosed           -> NtcSuccess, NtcError, Disconnect, NtdSuccess, NtdError, NtsClosed, NteClosed, RtConnect, RsConnect, RfConnectFF, RfConnectFT
  ...
  @Test fun testQuarterConnectDisconnectNteClosedRfConnectFF() = testQuarterConnectDisconnectNteClosedRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectDisconnectNteClosedRfConnectFT() = testQuarterConnectDisconnectNteClosedRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectDisconnectNteClosedRfConnectFF(manager: ConnectManager) {
    testTripleConnectDisconnectNteClosed(manager)
  ...
  protected fun testQuarterConnectDisconnectNteClosedRfConnectFT(manager: ConnectManager) {
    testTripleConnectDisconnectNteClosed(manager)
  ...
  // PAUSED         :                                          TRUE          TRUE
  //
  //                  Create -> Connect    -> Disconnect    -> PsConnect  -> RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECTING       CONNECTING    CONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :
  ...
  @Test fun testQuarterConnectDisconnectPsConnectRfConnectFF() = testQuarterConnectDisconnectPsConnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectDisconnectPsConnectRfConnectFT() = testQuarterConnectDisconnectPsConnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectDisconnectPsConnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectDisconnectPsConnect(manager)
  ...
  protected fun testQuarterConnectDisconnectPsConnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectDisconnectPsConnect(manager)
  ...
  // PAUSED         :                                                TRUE
  //
  //                  Create -> Connect    -> NteClosed(*,0)      -> PsConnect           -> RfConnectFF, RfConnectFT
  ...
  @Test fun testQuarterConnectNteClosedPsConnectRfConnectFF() = testQuarterConnectNteClosedPsConnectRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectNteClosedPsConnectRfConnectFT() = testQuarterConnectNteClosedPsConnectRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectNteClosedPsConnectRfConnectFF(manager: ConnectManager) {
    testTripleConnectNteClosedPsConnect(manager)
  ...
  protected fun testQuarterConnectNteClosedPsConnectRfConnectFT(manager: ConnectManager) {
    testTripleConnectNteClosedPsConnect(manager)
  ...
  // Test Cases:
  //                  Create -> Connect    -> PsConnect  -> NtcSuccess    -> Connect, NtcSuccess, NtcError, RtConnect, PsConnect
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECTING    DISCONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE             TRUE
  ...
  //
  //                  Create -> Connect    -> PsConnect  -> NtcSuccess    -> Disconnect
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECTING    DISCONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE
  ...
  // PAUSED         :                         TRUE          TRUE             TRUE
  //
  //                  Create -> Connect    -> PsConnect  -> NtcSuccess    -> NtdSuccess, NtsClosed
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECTING    DISCONNECT_COMPLETE
  // SUCCESS        :                                                        TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE             TRUE
  ...
  // PAUSED         :                         TRUE          TRUE             TRUE
  //
  //                  Create -> Connect    -> PsConnect  -> NtcSuccess    -> NtdError, NteClosed
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECTING    DISCONNECT_COMPLETE
  // SUCCESS        :                                                        FALSE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE             TRUE
  ...
  // PAUSED         :                         TRUE          TRUE             TRUE
  //
  //                  Create -> Connect    -> PsConnect  -> NtcSuccess    -> RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECTING    DISCONNECTING
  // SUCCESS        :
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE             TRUE
  ...
  @Test fun testQuarterConnectPsConnectNtcSuccessConnect() = testQuarterConnectPsConnectNtcSuccessConnect(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNtcSuccess() = testQuarterConnectPsConnectNtcSuccessNtcSuccess(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNtcError() = testQuarterConnectPsConnectNtcSuccessNtcError(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessDisconnect() = testQuarterConnectPsConnectNtcSuccessDisconnect(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNtdSuccess() = testQuarterConnectPsConnectNtcSuccessNtdSuccess(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNtdError() = testQuarterConnectPsConnectNtcSuccessNtdError(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNtsClosed() = testQuarterConnectPsConnectNtcSuccessNtsClosed(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessNteClosed() = testQuarterConnectPsConnectNtcSuccessNteClosed(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessRtConnect() = testQuarterConnectPsConnectNtcSuccessRtConnect(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessPsConnect() = testQuarterConnectPsConnectNtcSuccessPsConnect(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessRsConnect() = testQuarterConnectPsConnectNtcSuccessRsConnect(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessRfConnectFF() = testQuarterConnectPsConnectNtcSuccessRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcSuccessRfConnectFT() = testQuarterConnectPsConnectNtcSuccessRfConnectFT(ConnectManager())

  protected fun testQuarterConnectPsConnectNtcSuccessConnect(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNtcSuccess(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNtcError(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessDisconnect(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNtdSuccess(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNtdError(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNtsClosed(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessNteClosed(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessRtConnect(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessPsConnect(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessRsConnect(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessRfConnectFF(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcSuccessRfConnectFT(manager: ConnectManager) {
    testTripleConnectPsConnectNtcSuccess(manager)
  ...
  // PAUSED         :                         TRUE          TRUE                   TRUE
  //
  //                  Create -> Connect    -> PsConnect  -> NtcError            -> RsConnect, RfConnectFF, RfConnectFT
  // STATE          : null      CONNECTING    CONNECTING    DISCONNECT_COMPLETE    CONNECTING
  // SUCCESS        :                                       TRUE
  // RETRY_COUNT    :
  // WAIT_CONNECT   :                                       TRUE
  ...
  @Test fun testQuarterConnectPsConnectNtcErrorRfConnectFF() = testQuarterConnectPsConnectNtcErrorRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectPsConnectNtcErrorRfConnectFT() = testQuarterConnectPsConnectNtcErrorRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectPsConnectNtcErrorRfConnectFF(manager: ConnectManager) {
    testTripleConnectPsConnectNtcError(manager)
  ...
  protected fun testQuarterConnectPsConnectNtcErrorRfConnectFT(manager: ConnectManager) {
    testTripleConnectPsConnectNtcError(manager)
  ...
  @Test fun testQuarterConnectPsConnectNteClosedRfConnectFF() = testQuarterConnectPsConnectNteClosedRfConnectFF(ConnectManager())
  @Test fun testQuarterConnectPsConnectNteClosedRfConnectFT() = testQuarterConnectPsConnectNteClosedRfConnectFT(ConnectManager())
  ...
  protected fun testQuarterConnectPsConnectNteClosedRfConnectFF(manager: ConnectManager) {
    testTripleConnectPsConnectNteClosed(manager)
  ...
  protected fun testQuarterConnectPsConnectNteClosedRfConnectFT(manager: ConnectManager) {
    testTripleConnectPsConnectNteClosed(manager)
